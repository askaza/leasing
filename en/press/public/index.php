...
$APPLICATION->SetPageProperty('description', 'Homnet Leasing - publications in journals.');
$APPLICATION->SetPageProperty('title', 'Homnet Leasing | Хомнет Лизинг');
...
if($author > 0){
	...
	$aAuthor = CIBlockElement::GetList(
		array(),
		array(
			'IBLOCK_ID' => $GLOBALS['IBLOCKS_ID']['PUBLICATIONS_EN'],
