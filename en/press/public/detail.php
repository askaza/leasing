...
$APPLICATION->IncludeComponent(
	...
	Array(
		...
		'IBLOCK_TYPE' => 'en_content',	// Тип информационного блока (используется только для проверки)
		'IBLOCK_ID' => $GLOBALS['IBLOCKS_ID']['PUBLICATIONS_EN'],	// Код информационного блока
