...
<?elseif($arResult["ALLOW_ANONYMOUS"]=="N" || $_REQUEST["authorize"]=="YES" || $_REQUEST["register"]=="YES"):?>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
	<thead><tr><td colspan="2" style="padding-top:20px; padding-bottom:10px;"><b>Have you been regisered?</b></td></tr></thead>
	<tr valign="top">
		<td width="40%">
			<p>Login <span class="req">*</span><br />
...
<hr>
	<?if($arResult["ALLOW_REGISTER"]=="Y"):
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="data-table">
		<thead><tr><td colspan="2" style="padding-bottom:10px;"><b>Are you first time here? </b></td></tr></thead>
		<tr valign="top">
			<td width="40%">
