...
$res = CIBlockElement::GetList(Array(), Array('IBLOCK_ID'=>$GLOBALS['IBLOCKS_ID']['CLIENTS_REVIEWS_EN'], 'ACTIVE_DATE'=>'Y', 'ACTIVE'=>'Y', '!PROPERTY_link'=>false), false, false, array('ID', 'PROPERTY_link.NAME', 'PREVIEW_PICTURE','DETAIL_PICTURE' , 'PROPERTY_link'));
while($aClient = $res->GetNext()){
	$aClients[] = array(
		...
		'href'=> '/en/clients/'.$aClient['PROPERTY_LINK_VALUE'].'/'
	);
}
?>
