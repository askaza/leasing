...
<table width="461" cellspacing="0" cellpadding="0" border="0" class="graybacktable"> 
  <tbody> 
    <tr>
<td width="20">&nbsp;</td>
<td>
<br />
<table class="data-table bx-auth-table" cellspacing="0" width="100%">
	<tbody>
		<tr>
			<td width="1"><?=GetMessage("AUTH_LOGIN")?><br /><br /></td>
			<td><input type="text" name="USER_LOGIN" maxlength="50" value="<?=$arResult["LAST_LOGIN"]?>" size="30" class="inputtext"/><br /><br /></td>
		</tr>


		<tr>
			<td><?=GetMessage("AUTH_PASSWORD")?></td>
			<td><input type="password" name="USER_PASSWORD" maxlength="50" size="30" class="inputtext"/></td>
		</tr>
	...
	?>
		<tr>
			<td colspan="2" class="authorize-submit-cell" align="right"><input type="submit" name="Save" value=" " class="enterfb"></td>
		</tr>
	</tfoot>
</table>
