...
{?>
<table width="100%"><tr>
<td><h3 style="text-transform:uppercase;font-size:12px; padding-left:2px;"><?=$_REQUEST['title'];?></h3></td><td width="150"><a href="/clients/">Назад к списку клиентов</a></td>
</tr></table>
<?}?>
<?if($arResult["ITEMS"] && !$_REQUEST["rod"] && !$_REQUEST["project"]){?>
	...
	<table>
	<?$property_enums = CIBlockPropertyEnum::GetList(Array("SORT"=>"ASC", "DEF"=>"DESC"), Array("IBLOCK_ID"=>6, "CODE"=>"project"));
	while($enum_fields = $property_enums->GetNext())
	{
