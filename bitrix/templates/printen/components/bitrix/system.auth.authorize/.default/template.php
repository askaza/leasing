...
<td>
<br />
<table class="data-table bx-auth-table" cellspacing="0">
	<tbody>
		<tr>
			<td><?=GetMessage("AUTH_LOGIN")?><br /><br /></td>
	...
	?>
		<tr>
			<td colspan="2" class="authorize-submit-cell"><input type="submit" name="Save" value=" " class="enterfb"></td>
		</tr>
	</tfoot>
</table>
